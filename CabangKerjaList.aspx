<%@ Page Title="Cabang Kerja List | Quality" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CabangKerjaList.aspx.vb" Inherits="CabangKerjaList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Cabang Kerja List</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="EnterpriseHome.aspx">Home</a></li>
                            <li class="breadcrumb-item active">Cabang Kerja List</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <asp:LinkButton ID="btnAddMataKuliah" CssClass="btn btn-primary" ForeColor="white" runat="server"><span class="fas fa-plus"></span><asp:label ID="Label4" text="Add Cabang" CssClass="d-none d-sm-inline-block" style="padding-left: 5px;" runat="server" /></asp:LinkButton><div class="card-tools">
                ...
                <div class="card-body">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Id Cabang">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hyperLink1" runat="server" NavigateUrl='<%#String.Format("~/CabangKerja.aspx?idcabang={0}", HttpUtility.UrlEncode(Eval("idcabang").ToString())) %>'
                                        Text='<%# Eval("idcabang") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:connUQ %>"
        SelectCommand="SELECT idCabang as idCabang, lokasi as lokasi from TblCabang WHERE idCabang <> '' ORDER BY idCabang"></asp:SqlDataSource>
