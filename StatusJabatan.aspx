<%@ Page Title="Jabatan Kerja" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="StatusJabatan.aspx.vb" Inherits="StatusJabatan"%>
            ...
            <div class="card">
                ...
                <div class="card-body"> 
                           ...
                           <div class="input-group">
                              <%-- <div class="input-group-prepend">
                                 <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myKampus"><span class="fas fa-search"></span></button>
                                     ...
                                     <asp:TextBox ID="txtid" placeholder="Kode" runat="server" class="form-control input-sm" autocomplete="off" AutoPostBack="True" OnTextChanged="txtid_TextChanged" />
                               </div>
                      </div>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtlokasi" runat="server" placeholder="Jabatan" autocomplete="off" CssClass="form-control input-sm"></asp:TextBox>
                        </div>
                    </div>
                    <hr />
