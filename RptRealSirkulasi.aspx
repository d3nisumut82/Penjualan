<%@ Page Title="Report Sirkulasi Pinjaman" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RptRealSirkulasi.aspx.vb" Inherits="RptRealSirkulasi" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>REPORT SIRKULASI PINJAMAN</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <!-- Default box -->
                <div class="card-body"> 
                  ...
                  <div style="height:7px;"></div>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label style="height:33px;">TANGGAL AWAL </label> </div><div class="col-sm-3">
                                            <div class="input-group">
                                                <input id="dtpTglawal" runat="server" autocomplete="off" type="text" class="form-control datepicker" /> <div class="input-group-append">
                      ...
                      <div style="height:7px;"></div>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label style="height:33px;">TANGGAL AKHIR </label> </div><div class="col-sm-3">
                                            <div class="input-group">
                                                <input id="dtpTglakhir" runat="server" autocomplete="off" type="text" class="form-control datepicker" /> <div class="input-group-append">
                                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                                   </div>
                                            </div>
                                         </div>
