<%@ Page Title="Report Raalisasi Angsuran" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RptRealAngsuran.aspx.vb" Inherits="RptRealAngsuran" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>REPORT REALISASI ANGSURAN NASABAH</h1>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="card-body"> 
                    ...
                    <%-- <div style="height:7px;"></div>
                     ...
                     <%-- <div style="height:7px;"></div>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label style="height:33px;">TANGGAL </label> </div><div class="col-sm-3">
                                            <div class="input-group">
