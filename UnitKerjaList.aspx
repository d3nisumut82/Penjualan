<%@ Page Title="Unit Kerja List | Quality" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="UnitKerjaList.aspx.vb" Inherits="UnitKerjaList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <asp:LinkButton ID="btnAddMataKuliah" CssClass="btn btn-primary" ForeColor="white" runat="server"><span class="fas fa-plus"></span><asp:label ID="Label4" text="Add Unit" CssClass="d-none d-sm-inline-block" style="padding-left: 5px;" runat="server" /></asp:LinkButton><div class="card-tools">
                ...
                <div class="card-body">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="idunit">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hyperLink1" runat="server" NavigateUrl='<%#String.Format("~/unitkerja.aspx?idunit={0}", HttpUtility.UrlEncode(Eval("idunit").ToString())) %>'
                                        Text='<%# Eval("idunit") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:connUQ %>"
        SelectCommand="SELECT IDUNIT as IDUNIT, lokasi as lokasi from TblUnitKerja WHERE idunit <> '' ORDER BY IDUNIT"></asp:SqlDataSource>
