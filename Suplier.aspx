<%@ Page Title="Supplier" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Suplier.aspx.vb" Inherits="Suplier"%>
                 ...
                 <div class="row">        
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label class="text-center">ID SUPPLIER</label>
                        <asp:TextBox ID="txtidsupplier" runat="server" class="form-control input-sm" autocomplete="off" />
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
