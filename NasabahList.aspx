<%@ Page Title="Nasabah List | Quality" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="NasabahList.aspx.vb" Inherits="NasabahList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Nasabah List</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <asp:LinkButton ID="btnAddMataKuliah" CssClass="btn btn-primary" ForeColor="white" runat="server"><span class="fas fa-plus"></span><asp:label ID="Label4" text="Add Nasabah" CssClass="d-none d-sm-inline-block" style="padding-left: 5px;" runat="server" /></asp:LinkButton><div class="card-tools">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Kode">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hyperLink1" runat="server" NavigateUrl='<%#String.Format("~/Nasabah.aspx?IdNasabah={0}", HttpUtility.UrlEncode(Eval("IdNasabah").ToString())) %>'
                                        Text='<%# Eval("IDNasabah") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:connUQ %>"
        SelectCommand="SELECT IdNasabah as IdNasabah, IdCabang as IdCabang, IdUnit as IdUnit, Nama as Nama, Alamat as Alamat, TempatLahir as TempatLahir, CONVERT(VARCHAR(10),TGLLAHIR,103) AS TGLLAHIR, IdKTP as IdKTP, NoKK as NoKK, CONVERT(VARCHAR(10),TglDaftar,103)  AS TglDaftar, Domisili as Domisili, HP as HP  from TblNasabah WHERE IDNASABAH <> '' ORDER BY IDNASABAH"></asp:SqlDataSource>
