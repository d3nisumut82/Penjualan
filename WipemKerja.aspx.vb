    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Not IsPostBack Then
                txtid.Text = HttpUtility.UrlDecode(Request.QueryString("idwipem"))
...
#Region "Button"
    ...
    Protected Sub lnkSave_Click(sender As Object, e As System.EventArgs) Handles lnkSave.Click
        ...
        If Not CheckAdaData(txtid.Text.Trim(), "idwipem", "TblWipem") Then
            connectDB()
            mySqlCon.Open()
            ...
            Try
                mySqlCmd.CommandText = "INSERT INTO TblWipem (idwipem, lokasi) VALUES ('" _
            ...
            Finally
                ...
                Response.Redirect("WipemKerjaList.aspx")
            End Try
        Else
            connectDB()
            mySqlCon.Open()
            ...
            Try
                mySqlCmd.CommandText = "UPDATE TblWipem SET lokasi = '" & txtlokasi.Text.Trim() & "' WHERE idwipem = '" & txtid.Text.Trim() & "'; "
                mySqlCmd.ExecuteNonQuery()
...
#End Region
    ...
    Private Sub QueryAccount(ByVal a_Str As String, showmsg As Boolean)
        ...
        Finally
            ...
            command = New System.Data.OleDb.OleDbCommand("SELECT idwipem,lokasi FROM TblWipem WHERE idwipem = '" & a_Str & "'; ", mySqlCon)
...
#End Region
    ...
    Public Sub NOOTOMATIS()
        Dim NO As String = clsEnt.ReturnOneFieldConn("select top(1)idwipem + 1 as nnn from TblWipem order by idwipem desc ", "", "", "nnn", "connuq")
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As System.EventArgs) Handles lnkDelete.Click
        ...
        Try
            mySqlCmd.CommandText = "DELETE FROM TblWipem WHERE idwipem = '" & txtid.Text.Trim() & "'; "
            mySqlCmd.ExecuteNonQuery()
