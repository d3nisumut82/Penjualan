<%@ Page Title="Cabang Kerja" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CabangKerja.aspx.vb" Inherits="CabangKerja"%>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>DATA CABANG KERJA</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="EnterpriseHome.Aspx">Home</a></li>
                            <li class="breadcrumb-item active">DATA CABANG KERJA</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body"> 
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtlokasi" runat="server" placeholder="Lokasi" autocomplete="off" CssClass="form-control input-sm"></asp:TextBox>
                        </div>
                    </div>
                    <hr />
