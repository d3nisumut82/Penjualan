<%@ Page Title="Jabatan List | Quality" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="StatusJabatanList.aspx.vb" Inherits="StatusJabatanList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <asp:LinkButton ID="btnAddMataKuliah" CssClass="btn btn-primary" ForeColor="white" runat="server"><span class="fas fa-plus"></span><asp:label ID="Label4" text="Add Jabatan" CssClass="d-none d-sm-inline-block" style="padding-left: 5px;" runat="server" /></asp:LinkButton><div class="card-tools">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Kode">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hyperLink1" runat="server" NavigateUrl='<%#String.Format("~/StatusJabatan.aspx?kode={0}", HttpUtility.UrlEncode(Eval("kode").ToString())) %>'
                                        Text='<%# Eval("kode") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="nama" HeaderText="Jabatan" NullDisplayText="-" />
                        </Columns>
    ...
    <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:connUQ %>"
        SelectCommand="SELECT Kode as kode, nama as nama from TblJabatan WHERE kode <> '' ORDER BY kode"></asp:SqlDataSource>
