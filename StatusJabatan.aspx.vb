    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Not IsPostBack Then
                txtid.Text = HttpUtility.UrlDecode(Request.QueryString("kode"))
...
#Region "Button"
    ...
    Protected Sub lnkSave_Click(sender As Object, e As System.EventArgs) Handles lnkSave.Click
        ...
        If Not CheckAdaData(txtid.Text.Trim(), "kode", "TblJabatan") Then
            connectDB()
            mySqlCon.Open()
            ...
            Try
                mySqlCmd.CommandText = "INSERT INTO TblJabatan (kode, Nama) VALUES ('" _
            ...
            Finally
                ...
                Response.Redirect("StatusJabatanList.aspx")
            End Try
        Else
            connectDB()
            mySqlCon.Open()
            ...
            Try
                mySqlCmd.CommandText = "UPDATE TblJabatan SET Nama = '" & txtlokasi.Text.Trim() & "' WHERE kode = '" & txtid.Text.Trim() & "'; "
                mySqlCmd.ExecuteNonQuery()
...
#End Region
    ...
    Private Sub QueryAccount(ByVal a_Str As String, showmsg As Boolean)
        ...
        Finally
            ...
            command = New System.Data.OleDb.OleDbCommand("SELECT kode,Nama FROM TblJabatan WHERE kode = '" & a_Str & "'; ", mySqlCon)
            mySqlReader = command.ExecuteReader
            If mySqlReader.Read Then
                txtlokasi.Text = mySqlReader("Nama").ToString()
...
#End Region
    ...
    Public Sub NOOTOMATIS()
        Dim NO As String = clsEnt.ReturnOneFieldConn("select top(1)kode + 1 as nnn from TblJabatan order by kode desc ", "", "", "nnn", "connuq")
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As System.EventArgs) Handles lnkDelete.Click
        ...
        Try
            mySqlCmd.CommandText = "DELETE FROM TblJabatan WHERE kode = '" & txtid.Text.Trim() & "'; "
            mySqlCmd.ExecuteNonQuery()
